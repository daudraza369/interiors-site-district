// Fix Our Approach Section migration - Add missing columns safely
...
console.log('🔧 Fixing Our Approach Section migration...\n')
...
// Step 2: Connect using libsql client
...
try {
  ...
  const requiredColumns = [
    { name: 'our_approach_section_badge_text', type: 'TEXT', defaultValue: 'The Solution' },
    { name: 'our_approach_section_description', type: 'TEXT', defaultValue: 'Our approach transforms these hidden liabilities into competitive advantages. Through strategic biophilic design, we create environments where people don\'t just work—they thrive.' },
    { name: 'our_approach_section_cta_text', type: 'TEXT', defaultValue: 'Start Your Transformation' },
    { name: 'our_approach_section_cta_link', type: 'TEXT', defaultValue: '/contact' },
  ]
  ...
  console.log('   2. Go to Payload Admin → Home Page → Our Approach tab')
